...
def input_image_setup(uploaded_file):
    # Check the uploaded the file or not
...
# Now initialize the streamlit application for Front end setup

st.set_page_config(page_title = "Gemini Calory adviser Application")
st.header("Gemini Calory adviser Application")
...
You are an Expert in nutritionist where you need to see the food from the image
        ...
        mention the percentage split of the ratio of carbohydrates, fats, fibers, suger
